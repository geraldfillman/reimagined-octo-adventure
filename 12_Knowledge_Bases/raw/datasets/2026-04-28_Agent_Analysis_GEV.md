...
| risk | NEUTRAL | 0% | 2ms | risk agent failed: API key not configured for Financial Modeling Prep. Set FINANCIAL_MODELING_PREP_API_KEY in /home/user/reimagined-octo-ad |
| sentiment | NEUTRAL | 15% | 2ms | No recent headlines were available for sentiment scoring. |
| microstructure | NEUTRAL | 0% | 2ms | microstructure agent failed: API key not configured for Financial Modeling Prep. Set FINANCIAL_MODELING_PREP_API_KEY in /home/user/reimagined-octo-ad |
...
| prediction_market | NEUTRAL | 12% | 938ms | No relevant prediction markets found for "AI Power Infrastructure". |
