...
| --- | --- | --- | --- | --- |
| price | NEUTRAL | 0% | 3ms | price agent failed: API key not configured for Financial Modeling Prep. Set FINANCIAL_MODELING_PREP_API_KEY in /home/user/reimagined-octo-ad |
| risk | NEUTRAL | 0% | 3ms | risk agent failed: API key not configured for Financial Modeling Prep. Set FINANCIAL_MODELING_PREP_API_KEY in /home/user/reimagined-octo-ad |
| sentiment | NEUTRAL | 15% | 3ms | No recent headlines were available for sentiment scoring. |
| microstructure | NEUTRAL | 0% | 3ms | microstructure agent failed: API key not configured for Financial Modeling Prep. Set FINANCIAL_MODELING_PREP_API_KEY in /home/user/reimagined-octo-ad |
| macro | NEUTRAL | 10% | 1ms | FRED key is unavailable, so macro context was skipped. |
| fundamentals | NEUTRAL | 24% | 2ms | Revenue growth N/A, net margin N/A, trailing FCF 0.0. |
| prediction_market | NEUTRAL | 12% | 858ms | No relevant prediction markets found for "AI Power Infrastructure". |
