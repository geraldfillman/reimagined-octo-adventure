...
| --- | --- | --- | --- | --- |
| price | NEUTRAL | 30% | 2201ms | MSFT closed at 414.44. 7d -4.3%, 30d 6.5%. RSI 54.5, MACD positive. |
| risk | BEARISH | 61% | 2463ms | Risk read: 30d vol 32.1%, max drawdown -34.2%, 30d return 6.5%. |
| sentiment | BULLISH | 38% | 2586ms | 20 headline(s): 3 positive, 1 negative, net score 2. |
| microstructure | NEUTRAL | 28% | 2635ms | Volume ratio 0.86x, price change 1.6%, short/float N/A, entropy mixed. |
| macro | BULLISH | 36% | 192ms | Macro backdrop: VIX 16.89, curve 0.51, HY spread 2.8%. |
| fundamentals | BULLISH | 55% | 2802ms | Revenue growth 14.9%, net margin 36.1%, trailing FCF 142.3B. |
| auction | NEUTRAL | 22% | 1342ms | Auction state: balance. at POC 413.74. Session bars: 390. |
| pair | NEUTRAL | 5% | 1ms | MSFT is not in any configured pair watchlist. |
| pead | NEUTRAL | 10% | 1433ms | No recent earnings within 90 days for MSFT. |
| prediction_market | NEUTRAL | 12% | 147ms | No relevant prediction markets found for "AI Power Defense Stack". |
...
- **Signal**: NEUTRAL
- **Confidence**: 28%
- **Summary**: Volume ratio 0.86x, price change 1.6%, short/float N/A, entropy mixed.
- **Evidence**:
  - Volume: 31.2M vs avg 36.3M
  - Market cap: 3.1T
...
- **Signal**: NEUTRAL
- **Confidence**: 22%
- **Summary**: Auction state: balance. at POC 413.74. Session bars: 390.
- **Evidence**:
  - Auction state: balance
  - VP — POC: 413.7402, VAH: 415.3952, VAL: 412.9126
  - TPO POC: 413.7402
  - AVWAP unavailable
  - Volume ratio N/A
- **Warnings**:
