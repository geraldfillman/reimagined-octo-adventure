...
| --- | --- | --- | --- | --- |
| price | BEARISH | 60% | 1258ms | PLTR closed at 144.07. 7d -5.6%, 30d -7.5%. RSI 50.6, MACD bullish_cross. |
| risk | BEARISH | 61% | 1520ms | Risk read: 30d vol 57.8%, max drawdown -38.2%, 30d return -7.5%. |
| sentiment | NEUTRAL | 22% | 4060ms | 20 headline(s): 1 positive, 1 negative, net score 0. |
| microstructure | BULLISH | 31% | 6521ms | Volume ratio 0.62x, price change 3.6%, short/float N/A, entropy mixed. |
| macro | BULLISH | 36% | 196ms | Macro backdrop: VIX 16.89, curve 0.51, HY spread 2.8%. |
| fundamentals | BULLISH | 65% | 6237ms | Revenue growth 56.2%, net margin 36.3%, trailing FCF 3.2B. |
| auction | NEUTRAL | 22% | 3160ms | Auction state: balance. at POC 144.27. Session bars: 390. |
| pair | NEUTRAL | 5% | 2ms | PLTR is not in any configured pair watchlist. |
| pead | NEUTRAL | 10% | 3229ms | No recent earnings within 90 days for PLTR. |
| prediction_market | NEUTRAL | 12% | 177ms | No relevant prediction markets found for "AI Power Defense Stack". |
...
- **Evidence**:
  - Palantir Q1 Earnings Preview: A Make Or Break Moment For The Bull Case
