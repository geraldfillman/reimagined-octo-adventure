...
- **Reasoning**: Deterministic synthesis is bullish at 50% confidence. Agent entropy is mixed (0.51). Drivers: price, risk. 5 neutral layer(s).
...
| --- | --- | --- | --- | --- |
| price | BULLISH | 53% | 270ms | GEV closed at 1062.95. 7d -5.7%, 30d 21.1%. RSI 59.7, MACD bearish_cross. |
| risk | BULLISH | 43% | 267ms | Risk read: 30d vol 56.6%, max drawdown -17.5%, 30d return 21.1%. |
| sentiment | BULLISH | 38% | 537ms | 20 headline(s): 2 positive, 0 negative, net score 2. |
| microstructure | NEUTRAL | 24% | 451ms | Volume ratio 0.65x, price change -1.9%, short/float N/A, entropy mixed. |
| macro | BULLISH | 36% | 346ms | Macro backdrop: VIX 16.89, curve 0.51, HY spread 2.8%. |
| fundamentals | BULLISH | 48% | 255ms | Revenue growth 8.9%, net margin 12.8%, trailing FCF 10.9B. |
| auction | NEUTRAL | 22% | 436ms | Auction state: balance. below VAL 1070.61. Session bars: 390. |
| pair | NEUTRAL | 5% | 26ms | GEV is not in any configured pair watchlist. |
| pead | NEUTRAL | 10% | 241ms | No recent earnings within 90 days for GEV. |
| prediction_market | NEUTRAL | 12% | 469ms | No relevant prediction markets found for "AI Power Defense Stack". |
...
- **Signal**: NEUTRAL
- **Confidence**: 22%
- **Summary**: Auction state: balance. below VAL 1070.61. Session bars: 390.
- **Evidence**:
  - Auction state: balance
  - VP — POC: 1072.7659, VAH: 1083.5318, VAL: 1070.6127
  - TPO POC: 1072.7659
  - AVWAP unavailable
  - Volume ratio N/A
- **Warnings**:
