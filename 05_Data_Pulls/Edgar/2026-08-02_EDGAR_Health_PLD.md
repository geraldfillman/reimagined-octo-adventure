---
title: "EDGAR Health Markers — Prologis"
source: "sec-edgar"
...
Quantitative layer of [[04_Reference/Corporate_Health_Integrity_Framework]] — §5 screening bands (profile: **reit**) plus the §9.2 relative-performance prompt.
...
Rollup: 🟢 3 constructive · 🟡 1 investigate · 🔴 0 concern · ⚪ 7 n/a → `signal_status: clear`
...
| ⚪ n/a | §5.5 | Net debt / EBITDA | — | §14: ordinary leverage bands do not apply to reit filers — use the sector emphasis list instead. |
| ⚪ n/a | §5.5 | EBIT / interest expense | — | §14: interest expense is a core operating cost for reit filers — coverage bands do not apply. |
| 🟢 constructive | §5.6 | Diluted share growth (YoY) | +0.3% | Dilution below 1% per year. |
| 🟢 constructive | §5.6 | Stock compensation / revenue | +2.1% | SBC modest relative to revenue. |
...
| 🟢 constructive | §9.2 | 12-month return vs XLRE | +37.8% vs +9.2% (+28.7%pp) | Within normal range of the benchmark; §9 ownership and volume markers still need the manual pass. |
...
3. Score §16 (economic 40 / stewardship 40 / market 20) — scaffold with `node run.mjs edgar health --ticker PLD --review`.
