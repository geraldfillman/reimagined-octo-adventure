---
title: "EDGAR Health Markers — Vertiv Holdings Co"
source: "sec-edgar"
...
| --- | --- | --- | --- | --- |
| 🟢 constructive | §5.3 | FCF conversion (cumulative FCF / net income, ≤5 FY) | 1.49 | 5 FY window — earnings are converting to cash. |
| 🟢 constructive | §5.3 | Operating cash flow vs earnings trend | aligned | Operating cash tracks earnings direction. |
| 🟢 constructive | §5.3 | Receivables growth − revenue growth | +3.9%pp | Collections keeping pace with reported revenue. |
| 🟢 constructive | §5.3 | Inventory growth − cost-of-sales growth | -11.3%pp | Inventory tracking cost of sales. |
| 🟢 constructive | §5.5 | Net debt / EBITDA | 0.55x | Leverage comfortable for a non-financial filer. |
| 🟢 constructive | §5.5 | EBIT / interest expense | 21.25x | Interest burden well covered by operating earnings. |
| 🟡 investigate | §5.6 | Diluted share growth (YoY) | +1.1% | 1–3% annual dilution — net buybacks against grants (statement of equity). |
| 🟢 constructive | §5.6 | Stock compensation / revenue | +0.4% | SBC modest relative to revenue. |
| ⚪ n/a | §5.6 | Gross buybacks vs net share count | — | No share repurchases in the latest fiscal year. |
| 🟢 constructive | §5.7 | Dividend / free cash flow | +4% of FCF | Payout within the comfortable range for a mature company. |
| 🟢 constructive | §9.2 | 12-month return vs XLI | +70.6% vs +20.1% (+50.5%pp) | Within normal range of the benchmark; §9 ownership and volume markers still need the manual pass. |
...
| buybacks | 4 | 2025-12-31 | 2022-12-31 |
...
3. Score §16 (economic 40 / stewardship 40 / market 20) — scaffold with `node run.mjs edgar health --ticker VRT --review`.
