---
title: "EDGAR Health Markers — JPMorgan Chase"
source: "sec-edgar"
...
Quantitative layer of [[04_Reference/Corporate_Health_Integrity_Framework]] — §5 screening bands (profile: **bank**) plus the §9.2 relative-performance prompt.
...
| 🟢 constructive | §5.6 | Diluted share growth (YoY) | -3.4% | Net share count declining. |
| 🟢 constructive | §5.6 | Stock compensation / revenue | +2.0% | SBC modest relative to revenue. |
| 🟢 constructive | §5.6 | Gross buybacks vs net share count | -3.4% | Net share count declining — buybacks exceed issuance. |
| ⚪ n/a | §5.7 | Dividend / free cash flow | — | OCF or capex unavailable — cannot compute FCF payout. |
| 🟢 constructive | §9.2 | 12-month return vs XLF | +21.6% vs +10.8% (+10.8%pp) | Within normal range of the benchmark; §9 ownership and volume markers still need the manual pass. |
...
| debtLongTerm | 6 | 2013-12-31 | 2008-12-31 |
| debtCurrent | 0 | — | — |
...
3. Score §16 (economic 40 / stewardship 40 / market 20) — scaffold with `node run.mjs edgar health --ticker JPM --review`.
