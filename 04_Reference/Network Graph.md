...
Summary:
- High-level graph status for entities, regimes, indicators, theses, and bridge candidates.
- Use this before opening large graph-heavy folders or running InfraNodus.
