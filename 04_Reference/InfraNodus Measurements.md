...
Summary:
- Entry point for graph measurement work across entities, macro, theses, sources, and evidence folders.
- Open this before running InfraNodus so scope choice and follow-up actions stay consistent.
