...
**Summary:** 86 source→puller gaps | 68 puller→source gaps | 38 output→dashboard gaps
...
Pullers with no source note linking them: **68**
...
Pullers whose output category is not referenced by any dashboard: **38**
...
---
_Generated by `node run.mjs system coverage-audit` on 2026-05-07_
