...
export const SECTOR_COMPANIES = Object.freeze({
  Technology: [
    ...
    { ticker: 'AAPL', cik: '0000320193', name: 'Apple',            cap: 'large' },
    { ticker: 'GOOG', cik: '0001652044', name: 'Alphabet Class C', cap: 'large' },
    { ticker: 'AVGO', cik: '0001730168', name: 'Broadcom',         cap: 'large' },
    { ticker: 'INTC', cik: '0000050863', name: 'Intel',            cap: 'large' },
    { ticker: 'AMD',  cik: '0000002488', name: 'Advanced Micro Devices', cap: 'large' },
    { ticker: 'CSCO', cik: '0000858877', name: 'Cisco Systems',    cap: 'large' },
    { ticker: 'MU',   cik: '0000723125', name: 'Micron Technology',cap: 'large' },
  ...
  Energy: [
    ...
    { ticker: 'CNX',  cik: '0001070412', name: 'CNX Resources',    cap: 'mid'   },
  ...
  Financials: [
    ...
    { ticker: 'BAC',  cik: '0000070858', name: 'Bank of America',  cap: 'large' },
    { ticker: 'V',    cik: '0001403161', name: 'Visa',             cap: 'large' },
