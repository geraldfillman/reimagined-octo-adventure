...
# BANK OF AMERICA CORP /DE/ â€” Company Dossier
...
> Generate the filing inventory with `node run.mjs edgar baseline --ticker BAC` â€” link the latest pull note here.
...
> Generate from XBRL with `node run.mjs edgar facts --ticker BAC` â€” link the latest pull note here, then interpret.
