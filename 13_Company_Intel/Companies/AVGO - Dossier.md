...
# Broadcom Inc. â€” Company Dossier
...
> Generate the filing inventory with `node run.mjs edgar baseline --ticker AVGO` â€” link the latest pull note here.
...
> Generate from XBRL with `node run.mjs edgar facts --ticker AVGO` â€” link the latest pull note here, then interpret.
