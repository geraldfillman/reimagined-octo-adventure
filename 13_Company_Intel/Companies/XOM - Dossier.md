...
one_liner: "Finds, produces, refines, and sells oil, natural gas, and fuels."
...
# EXXON MOBIL CORP — Company Dossier
...
Finds, produces, refines, and sells oil, natural gas, and fuels.

> Research angle (framework §14): Commodity production, refining, capital discipline, geopolitical exposure
...
> Generate the filing inventory with `node run.mjs edgar baseline --ticker XOM` — link the latest pull note here.
...
> Generate from XBRL with `node run.mjs edgar facts --ticker XOM` — link the latest pull note here, then interpret.
