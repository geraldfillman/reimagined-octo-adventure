...
ticker: "URI"
cik: "0001067701"
sector: "Services-Equipment Rental & Leasing, NEC"
...
# UNITED RENTALS, INC. â€” Company Dossier
...
> Generate the filing inventory with `node run.mjs edgar baseline --ticker URI` â€” link the latest pull note here.
...
> Generate from XBRL with `node run.mjs edgar facts --ticker URI` â€” link the latest pull note here, then interpret.
