...
one_liner: "Attracts attention through social applications and sells advertisers access to that attention."
...
# Meta Platforms, Inc. — Company Dossier
...
Attracts attention through social applications and sells advertisers access to that attention.

> Research angle (framework §14): Attention, advertising, AI distribution, founder voting control
...
> Generate the filing inventory with `node run.mjs edgar baseline --ticker META` — link the latest pull note here.
...
> Generate from XBRL with `node run.mjs edgar facts --ticker META` — link the latest pull note here, then interpret.
