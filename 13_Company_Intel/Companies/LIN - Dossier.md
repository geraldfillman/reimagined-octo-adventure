...
one_liner: "Produces industrial gases and sells them to factories, hospitals, and refineries under long-term contracts."
...
Produces industrial gases and sells them to factories, hospitals, and refineries under long-term contracts.

> Research angle (framework §14): Industrial-gas contracts, pricing durability, capital intensity
...
> Generate the filing inventory with `node run.mjs edgar baseline --ticker LIN` — link the latest pull note here.
...
> Generate from XBRL with `node run.mjs edgar facts --ticker LIN` — link the latest pull note here, then interpret.
